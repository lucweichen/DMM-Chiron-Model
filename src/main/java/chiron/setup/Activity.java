...
public class Activity {
    ...
    public Activity(String tag, Type type, String description, String template, String activation, String extractor, String workload) {
        this.tag = tag;
        this.type = type;
        ...
        this.workload = Double.parseDouble(workload);
    }

    public Activity(String tag, String atype, String description, String templatedir, String activation, String extractor, String constrained, String workload) {
        this.input = new ArrayList<Relation>();
        this.output = new ArrayList<Relation>();
        this.tag = tag;
        this.atype = atype;
    ...
    public Activity(int actid, int wkfid, String tag, String atype, String description, String templatedir, String activation, String extractor, String constrained) {
        this.input = new ArrayList<Relation>();
        this.output = new ArrayList<Relation>();
        this.actid = actid;
        this.wkfid = wkfid;
    ...
    public String getDropStatement() {
        ...
        for (Relation i : input) {
            statement += "DROP TABLE \"" + i.getRname() + "\" CASCADE;" + line;
            if (i.getDependencyUp() == null) {
                statement += "DROP SEQUENCE \"" + i.getRname().toLowerCase() + "_seq\";" + line;
            }
        }
        for (Relation o : output) {
            statement += "DROP TABLE \"" + o.getRname() + "\" CASCADE;" + line;
            statement += "DROP SEQUENCE \"" + o.getRname().toLowerCase() + "_seq\";" + line;
        }
        return statement;
    }
